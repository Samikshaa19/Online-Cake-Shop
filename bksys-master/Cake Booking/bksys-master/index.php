    ...
    <div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
        ...
        <nav class="menu_nav">
            <ul class="menu_mm">
                ...
                <li class="menu_mm"><a href='sign_up.php'>signup</a></li>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar_nav">
            <ul>
                ...
                <li><a href="sign_up.php">signup<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                    ...
                    <div class="col">
                        <div class="products_container grid">
                            ...
                            <div class="product grid-item">
                                <div class="product_inner">
                                    <div class="product_image"><img src="images/c2.jpg" alt=""></div>
                                    <div class="product_content text-center">
